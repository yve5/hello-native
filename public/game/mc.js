(function (lib, img, cjs, ss) {
  ...
  lib.webfontAvailable = function (family) {
    ...
    var txtFilters =
      (lib.webFontTxtFilters && lib.webFontTxtFilters[family]) || [];
  ...
  (lib.td3 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        ''
      );
    ...
    this.shape_1.graphics
      .f('#130B00')
      .s()
      .p('AlnAsQD5AQBuiGQB+B3DqgBQi1AfizAAQiyAAi1gfg');
    ...
    this.shape_2.graphics
      .f('#FFB132')
      .s()
      .p('AmOk/QGOBQGPhQQknEghoFeQh6l7kUkDg');
    ...
    this.shape_3.graphics
      .f('#D07200')
      .s()
      .p('ADclmQidF5CdEsQjqhajMCDQCsmmEKkog');
    ...
    this.shape_4.graphics
      .f('#6E3C00')
      .s()
      .p('AjGEYQBzkOhzlJQD1EBCYF9QjAiKjNBjg');
    ...
    this.shape_5.graphics
      ...
      .s()
      .p(
        'AmhN+IsgpYQkJk0EJlyIL4owQGYiaHWCaIMgJYQEDFUkDECItIKAQjDCAjGAAQjIAAjNiAg'
      );
    ...
    this.shape_6.graphics
      ...
      .s()
      .p(
        'AHLRaItuqAQkHkliJmBIAAsgQDDjsD1DEQHZCyFFGmQGmDmgWGYIAAMgQgHCMi7AAQhGAAhggUg'
      );
    ...
    this.shape_7.graphics
      ...
      .s()
      .p(
        'AsEP9Qi6ltC6mzQg4m8HIjCQEOm6I4jGQD1jSCbD6IAANIQhiFJjeENIu+LQQhCANg3AAQiwAAg/iFg'
      );
  ...
  (lib.td2 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        'AkXFJQhkgxhWhxQhWhwgUhsQgVhuA5grQA4grBlAxQBkAxBWBwQBWBvAUBuQAVBug4ArQgbAUgkAAQgpAAg2gagAF7DJQhkgxhWhwQhWhugUhvQgVhuA5grQA4grBlAxQBkAyBWBwQBWBwAUBsQAVBug4ArQgbAUgkAAQgpAAg2gag'
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        ''
      );
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        ''
      );
    ...
    this.shape_7.graphics
      ...
      .s()
      .p(
        'AmVOHIsgpYQkYkQEYmWIL4owQGYiaHWCaIMgJYQDiFLjiELItIKAQjIBujGAAQjIAAjIhug'
      );
    ...
    this.shape_8.graphics
      ...
      .s()
      .p(
        'AHLRXItuqAQkGkliJmBIAAsgQCdjXEbCvQIdBPEBIJQFoDdAoGhIAAMgQgPCIjBAAQhCAAhXgQg'
      );
    ...
    this.shape_9.graphics
      ...
      .s()
      .p(
        'AsaPwQhhl1BhmrQAmmpFqjVQFWnIHwi4QDsicCkDEIAANJQhiFIjeENIu+LQQhOAMg9AAQjPAAgOiEg'
      );
  ...
  (lib.td1 = function (mode, startPosition, loop) {
    ...
    this.shape_5.graphics
      ...
      .s()
      .p(
        'AmYONIsgpYQj/ktD/l5IL4owQGYiaHWCaIMgJYQDVE3jVEfItIKAQjIBijGAAQjIAAjIhig'
      );
    ...
    this.shape_6.graphics
      ...
      .s()
      .p(
        'AHLRTItuqAQkGkliJmBIAAsgQC4i8EACUQHvDUEvGEQFYD5A4GFIAAMgQhHCCi2AAQgyAAg6gKg'
      );
    ...
    this.shape_7.graphics
      ...
      .s()
      .p(
        'AsRPzQiFl1CFmrQAjlxFtkNINGqAQDQicDADEIAANIQhiFJjeENIu+LQQgtAGgoAAQi/AAhUh+g'
      );
  ...
  (lib.BT_GRAPH = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f('#FFFFFF')
      .s()
      .p('AolF8QiCAAABiDIAAnxQgBiDCCAAIRKAAQCDAAAACDIAAHxQAACDiDAAg');
    ...
    this.shape_1.graphics
      .f('#CCCCCC')
      .s()
      .p('AolGPQiWABAAiXIAAnxQAAiWCWgBIRKAAQCWABAACWIAAHxQAACXiWgBg');
    ...
    this.shape_2.graphics
      .f('#333333')
      .s()
      .p('AolGZQigAAAAigIAAnxQAAihCgAAIRKAAQCgAAAAChIAAHxQAACgigAAg');
  ...
  (lib.titledice = function (mode, startPosition, loop) {
    ...
    this.shape_1 = new cjs.Shape();
    this.shape_1.graphics
      .rf(['#FF6600', '#FFFF00'], [0, 1], 0, 0, 0, 0, 0, 208.2)
      .s()
      .p(
        ''
      );
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        'AnyK8IvoH0IHzvpIyvhkIRLnxInzq9IPoBkIAAnzIJWEsIGQmRIGGJ2IONjlInzJYIPoEsIvCGbIIxN2IvomPIAAOEInzq9IpXMhg'
      );
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        'AnyK8IvoHzIHzvoIywhkIRMnyInzq7IPoBkIAAn1IJWEtIGQmRIGGJ2IONjlInzJXIPoEtIvCGbIIxN2IvomPIAAOEInzq8IpXMgg'
      );
  ...
  (lib.btn_over = function (mode, startPosition, loop) {
    ...
    this.instance.filters = [
      new cjs.ColorFilter(0.6, 0.6, 0.6, 1, 102, 102, 102, 0),
    ];
  ...
  (lib.mc = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        'AmiDbQhlAAABhkIAAjuQgBhjBlgBINFAAQBkABAABjIAADuQAABkhkAAgAnfh3IAADuQAAA8A9ABINFAAQA8gBABg8IAAjuQgBg7g8AAItFAAQg9AAAAA7g'
      );
    ...
    this.shape_1.graphics
      .f('#FF9900')
      .s()
      .p('AmiC0Qg9gBAAg8IAAjuQAAg7A9AAINFAAQA8AAABA7IAADuQgBA8g8ABg');
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        'AoBNBQg6goAQhvQARhvBQh1QBRh1Bhg2QBjg3A6AoQA5AogQBvQgQBvhQB1QhRB1hiA2Qg5AggrAAQgfAAgZgRgAB9kLQg6goAQhvQARhvBQh1IAJgMQBNhsBcgzQBjg3A6AoQA5AogQBvIgEAXQgUBkhIBpQhRB1hiA2Qg5AggrAAQgfAAgZgRg'
      );
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        ''
      );
    ...
    this.shape_4.graphics
      ...
      .s()
      .p(
        'An4GBQjSigAAjhQAAjhDSifQDRifEngBQEoABDRCfQDRCfABDhQgBDhjRCgQjRCfkoAAQknAAjRifg'
      );
    ...
    this.shape_5.graphics
      ...
      .s()
      .p(
        'AmmJEQh1hVAqjmQAqjmCvjuQCvjxDMhuQA0gbAvgQQBzgmBQAmQAQAIAOAKQB1BVgqDnQgqDmivDuQivDwjNBvQh0A9hYAAQhEAAgzglg'
      );
    ...
    this.shape_6.graphics
      ...
      .s()
      .p(
        ''
      );
    ...
    this.shape_7.graphics
      ...
      .s()
      .p(
        'AhJLcQhhgOhLg5QhkhMAAhsQAAhrBkhNQBlhMCPAAQCOAABkBMQBmBNgBBrQABBshmBMQgSAOgTALQhZA0h0AAQglAAgjgGgAjxkkQhkhNgBhrQABhsBkhMQBlhNCOAAQCOAABmBNQBkBMABBsQgBBrhkBNQhmBMiOAAQiOAAhlhMg'
      );
    ...
    this.shape_8.graphics
      ...
      .s()
      .p(
        ''
      );
    ...
    this.shape_9.graphics
      ...
      .s()
      .p(
        'AmmJEQh1hVAqjmQAqjnCvjuQCvjwDMhuQDPhuB1BVQB1BVgqDmQgqDmivDvQivDwjNBuQh0A+hYAAQhEAAgzglg'
      );
    ...
    this.shape_10.graphics
      ...
      .s()
      .p(
        'Ai7CKQhNg4AAhQQAAhOBNg4QBNg4BtAAQBrAABNA4QBNA4AABOQAABQhNA4QhNA4hrAAQhtAAhNg4gAvrCFQhMg3AAhOQAAhPBMg5QBOg4BtAAQBsAABOA4QBMA5AABPQAABOhMA3QhOA5hsAAQhtAAhOg5gAJ4CEQhOg3AAhOQAAhPBOg5QBNg4BtAAQBtAABMA4QBOA5AABPQAABOhOA3QhMA5htAAQhtAAhNg5g'
      );
    ...
    this.shape_11.graphics
      ...
      .s()
      .p(
        'ACCFSQg5gqAShtQARhtBThuQBThxBjgxQBjgxA5AqQA5AqgSBtQgSBrhSBwQhTBxhjAxQg1AagpAAQgjAAgbgTgAoQDKQg5gqAShtQARhrBThwQBThxBjgxQBjgxA5AqQA5AqgSBtQgSBthSBuQhTBxhjAxQg1AagpAAQgjAAgbgTg'
      );
    ...
    this.shape_12.graphics
      ...
      .s()
      .p(
        ''
      );
    ...
    this.shape_13.graphics
      ...
      .s()
      .p(
        ''
      );
    ...
    this.shape_14.graphics
      ...
      .s()
      .p(
        ''
      );
    ...
    this.shape_15.graphics
      ...
      .s()
      .p(
        ''
      );
    ...
    this.shape_16.graphics
      ...
      .s()
      .p(
        ''
      );
    ...
    this.shape_17.graphics
      ...
      .s()
      .p(
        'AkXFJQhlgyhVhwQhWhwgUhsQgVhuA4grQA5grBlAxQBkAxBWBwQBVBuAVBvQAVBug5ArQgaAUgkAAQgpAAg2gagAF7DJQhlgxhVhwQhWhvgUhuQgVhuA4grQA5grBlAxQBkAxBWBxQBVBwAVBsQAVBug5ArQgaAUgkAAQgpAAg2gag'
      );
    ...
    this.shape_18.graphics
      ...
      .s()
      .p(
        ''
      );
    ...
    this.shape_19.graphics
      ...
      .s()
      .p(
        ''
      );
    ...
    this.shape_23.graphics
      ...
      .s()
      .p(
        ''
      );
    ...
    this.shape_24.graphics
      ...
      .s()
      .p(
        ''
      );
    ...
    this.shape_25.graphics
      ...
      .s()
      .p(
        ''
      );
    ...
    this.shape_26.graphics
      .f('#0A0013')
      .s()
      .p('AhFBKQiRgFiQgZQC1AMBshEQApgaAcgkQB+B3DqgBQi0Afi0AAIhFgBg');
    ...
    this.shape_27.graphics
      .f('#B544FF')
      .s()
      .p('AhFCLQh5kHjRjDQCmAhCkAGQDqAIDqgvQknEghoFeQgdhdgohXg');
    ...
    this.shape_28.graphics
      .f('#6500C9')
      .s()
      .p('ADclmQidF5CdEsQjrhajLCDQCsmmEKkog');
    ...
    this.shape_29.graphics
      .f('#330067')
      .s()
      .p('AjGEYQBzkNhzlKQD1EBCYF9QjAiKjNBjg');
    ...
    this.shape_58.graphics
      ...
      .s()
      .p(
        'AgsPlQjIgOilhCIsgpYQjfkjDfmDIL4owQGYiaHWCaIMgJYQC5FBi5EVItIKAQjNBSiyAAQgYAAgagCg'
      );
    ...
    this.shape_59.graphics
      ...
      .s()
      .p(
        'AguPiQjIgRilg6IsgpYQjhktDhl5IL4owQGYiaHWCaIMgJYQDDFJjDENItIKAQjHBOiuAAQgdAAgfgDg'
      );
    ...
    this.shape_60.graphics
      ...
      .s()
      .p(
        'AgiPmQjIgYilg8IsgpYQkHk/EHlnIL4owQGYiaHWCaIMgJYQC6FBi6EVItIKAQjABYipAAQgmAAgigEg'
      );
    ...
    this.shape_61.graphics
      ...
      .s()
      .p(
        'Ag0PtQjFgbiehIIsgpYQjqktDql5IL4owQGYiaHWCaIMgJYQC9FCi9EUItIKAQjNBoipAAQgjAAgigFg'
      );
    ...
    this.shape_62.graphics
      ...
      .s()
      .p(
        'AgmPrQjHgXihhHIsgpYQkAktEAl5IL4owQGYiaHWCaIMgJYQCuFJiuENItIKAQjKBiirAAQggAAghgEg'
      );
    ...
    this.shape_63.graphics
      ...
      .s()
      .p(
        'AgfPqQjJgRiphJIsgpYQj+kjD+mDIL4owQGYiaHWCaIMgJYQC4FJi4ENItIKAQjGBcixAAQgaAAgbgCg'
      );
    ...
    this.shape_64.graphics
      ...
      .s()
      .p(
        'AgrPmQjIgXilg9IsgpYQjhkjDhmDIL4owQGYiaHWCaIMgJYQC2FBi2EVItIKAQjBBYipAAQgjAAgkgEg'
      );
    ...
    this.shape_65.graphics
      ...
      .s()
      .p(
        'AgpPlQjIgRilg/IsgpYQjqktDql5IL4owQGYiaHWCaIMgJYQC4FJi4ENItIKAQjJBSivAAQgcAAgdgCg'
      );
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        .to({ state: [] })
        .to({ state: [{ t: this.shape_58 }] }, 17)
        .to({ state: [{ t: this.shape_59 }] }, 6)
        .to({ state: [{ t: this.shape_60 }] }, 6)
        .to({ state: [{ t: this.shape_61 }] }, 6)
        .to({ state: [{ t: this.shape_62 }] }, 6)
        .to({ state: [{ t: this.shape_63 }] }, 6)
        .to({ state: [{ t: this.shape_64 }] }, 6)
        .to({ state: [{ t: this.shape_65 }] }, 6)
        .to({ state: [] }, 6)
        .wait(1)
    );
    ...
    this.shape_66.graphics
      ...
      .s()
      .p(
        'AHMRfItvqAQkGkliJmBIAAsgQDCjbD2CzQHsDNExGLQD4CjBCC7QBDC5AUBnIAAMgQgeAlgpAZQhcA7iRAAQgaAAgagBg'
      );
    ...
    this.shape_67.graphics
      ...
      .s()
      .p(
        'AHMRaItvqAQkGkliJmBIAAsgQCTjGElCeQG/CgFeG4QEICjA8C7QA9C5AQBnIAAMgQgeAkgpAaQhcA7iRAAQgaAAgagBg'
      );
    ...
    this.shape_68.graphics
      ...
      .s()
      .p(
        'AHMRUItvqAQkGkliJmBIAAsgQCwiwEICIQH7CDEiHVQEQCUA5DBQA6C+AOBrIAAMgQgeAlgpAaQhcA7iRAAQgaAAgagCg'
      );
    ...
    this.shape_69.graphics
      ...
      .s()
      .p(
        'AHMRfItvqAQkGkliJmBIAAsgQC5jdD/C1QHuCvEvGpQD/CdBBC9QBAC7ARBpIAAMgQgeAlgpAaQhcA7iRAAQgaAAgagCg'
      );
    ...
    this.shape_70.graphics
      ...
      .s()
      .p(
        'AHMRUItvqAQkGkliJmBIAAsgQCOivEqCHQHQCVFNHDQEHC7A9CzQA+CwAPBgIAAMgQgeAlgpAZQhcA8iRAAQgaAAgagCg'
      );
    ...
    this.shape_71.graphics
      ...
      .s()
      .p(
        'AHMRcItvqAQkGkliJmBIAAsgQCdjOEbCmQHTCDFKHVQEIDDA8CvQA9CuAQBeIAAMgQgeAlgpAZQhcA7iRAAQgaAAgagBg'
      );
    ...
    this.shape_72.graphics
      ...
      .s()
      .p(
        'AHMRcItvqAQkGkliJmBIAAsgQCdjOEbCmQG1CXFoHBQD8CeBEC7QBDC5AOBsIAAMgQgeAlgpAZQhcA7iRAAQgaAAgagBg'
      );
    ...
    this.shape_73.graphics
      ...
      .s()
      .p(
        'AHMRbItvqAQkGkliJmBIAAsgQC6jKD+CiQHXCqFGGuQEKC6A6CzQA7CxASBgIAAMgQgeAlgpAZQhcA7iRAAQgaAAgagBg'
      );
    ...
    this.shape_74.graphics
      ...
      .s()
      .p(
        'AviP0Qg/AAgyglIt2qdQgjgcgUgoQgUgoAAgrIAAmPQAAgwAWgpQAXgrAogZIN2pBQAwghA3AAMAhKAAAQA9AAAyAjILwIXQAjAZAXArQAUAoAAAuIAAG6QAAAmgPAlQgPAkgcAbIrFKdQg3AyhMAAg'
      );
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        ...
        .to({ state: [] }, 4)
        .to({ state: [{ t: this.shape_66 }] }, 6)
        .to({ state: [{ t: this.shape_67 }] }, 6)
        .to({ state: [{ t: this.shape_68 }] }, 6)
        .to({ state: [{ t: this.shape_69 }] }, 6)
        .to({ state: [{ t: this.shape_70 }] }, 6)
        .to({ state: [{ t: this.shape_71 }] }, 6)
        .to({ state: [{ t: this.shape_72 }] }, 6)
        .to({ state: [{ t: this.shape_73 }] }, 6)
        .to({ state: [{ t: this.shape_74 }] }, 6)
        .wait(1)
    );
    ...
    this.shape_76.graphics
      ...
      .s()
      .p(
        'AhFbZQiRgFiQgaItxqAQkGkliJmDIAAseQCsmnEMkpIL3owQGYiaHXCaIMgJYQD3EBCYF/IAANGQhhFLjeENIvALQQi0Agi0AAIhFgBg'
      );
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        .to({ state: [] })
        .to({ state: [{ t: this.shape_75 }] }, 7)
        .to({ state: [] }, 4)
        .to({ state: [{ t: this.shape_76 }] }, 6)
        .to({ state: [{ t: this.shape_77 }] }, 6)
        .to({ state: [{ t: this.shape_78 }] }, 6)
        .to({ state: [{ t: this.shape_79 }] }, 6)
        .to({ state: [{ t: this.shape_80 }] }, 6)
        .to({ state: [{ t: this.shape_81 }] }, 6)
        .to({ state: [{ t: this.shape_82 }] }, 6)
        .to({ state: [{ t: this.shape_83 }] }, 6)
        .to({ state: [] }, 6)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
